...
export default function HeadComponent({
  ...
  return (
    <Head>
      ...
      <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin={"origin"} />
      ...
      <link rel="mask-icon" href="/safari-pinned-tab.svg" data-color="#003232"></link>
      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          @font-face {
            ...
            font-weight: 100;
            font-display: swap;
            src: url(https://fonts.gstatic.com/s/lexend/v17/wlpwgwvFAVdoq2_v9aQU4Wc.woff2) format('woff2');
